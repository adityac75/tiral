...
# 1 "./src/main/drivers/accgyro_mpu6050.c"
# 19 "./src/main/drivers/accgyro_mpu6050.c"
...
# 22 "./src/main/drivers/accgyro_mpu6050.c" 2
...
# 26 "./src/main/drivers/accgyro_mpu6050.c" 2
...
static void mpu6050GyroInit(uint16_t lpf)
{
    ...
    delay(100);
    ack = mpuConfiguration.write(0x19, 0x00);
    ack = mpuConfiguration.write(0x6B, 0x03);
    delay(15);
    ack = mpuConfiguration.write(0x1A, mpuLowPassFilter);
