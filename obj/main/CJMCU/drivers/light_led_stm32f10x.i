...
void ledInit(void)
{
    ...
    struct {
        ...
        {
            .gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),
            .cfg = { Pin_14, Mode_Out_PP, Speed_2MHz }
        },


        {
            .gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),
            .cfg = { Pin_13, Mode_Out_PP, Speed_2MHz }
        },


        {
            .gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),
            .cfg = { Pin_15, Mode_Out_PP, Speed_2MHz }
        }
