...
static const beeperTableEntry_t beeperTable[] = {
    { BEEPER_GYRO_CALIBRATED,0,beep_gyroCalibrated },
    { BEEPER_RX_LOST_LANDING,1,beep_sos },
    { BEEPER_RX_LOST,2,beep_txLostBeep },
    { BEEPER_DISARMING,3,beep_disarmBeep },
    { BEEPER_ARMING,4,beep_armingBeep },
    { BEEPER_ARMING_GPS_FIX,5,beep_armedGpsFix },
    { BEEPER_BAT_CRIT_LOW,6,beep_critBatteryBeep },
    { BEEPER_BAT_LOW,7,beep_lowBatteryBeep },
    { BEEPER_GPS_STATUS,8,beep_multiBeeps },
    { BEEPER_RX_SET,9,beep_shortBeep },
    { BEEPER_ACC_CALIBRATION,10,beep_2shortBeeps },
    { BEEPER_ACC_CALIBRATION_FAIL,11,beep_2longerBeeps },
    { BEEPER_READY_BEEP,12,beep_readyBeep },
    { BEEPER_MULTI_BEEPS,13,beep_multiBeeps },
    { BEEPER_DISARM_REPEAT,14,beep_disarmRepeatBeep },
