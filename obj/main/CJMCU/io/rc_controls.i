...
# 53 "./src/main/io/rc_controls.c" 2
...
# 59 "./src/main/io/rc_controls.c" 2
...
# 61 "./src/main/io/rc_controls.c" 2
...
static const adjustmentConfig_t defaultAdjustmentConfigs[21 - 1] = {
    {
    ...
    switch(adjustmentFunction) {
        ...
        case ADJUSTMENT_PITCH_P:
            if ((pidProfile->pidController == 2)) {
                newFloatValue = constrainf(pidProfile->P_f[PIDPITCH] + (float)(delta / 10.0f), 0, 100);
        ...
        case ADJUSTMENT_ROLL_P:
            if ((pidProfile->pidController == 2)) {
                newFloatValue = constrainf(pidProfile->P_f[PIDROLL] + (float)(delta / 10.0f), 0, 100);
        ...
        case ADJUSTMENT_YAW_P:
            if ((pidProfile->pidController == 2)) {
                newFloatValue = constrainf(pidProfile->P_f[PIDYAW] + (float)(delta / 10.0f), 0, 100);
