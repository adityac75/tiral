...
# 12 "c:\\cygwin64\\dev\\building code\\arm-none-eabi\\include\\stdlib.h" 2 3
...
# 19 "c:\\cygwin64\\dev\\building code\\arm-none-eabi\\include\\stdlib.h" 2 3
...
_Bool isSerialConfigValid(serialConfig_t *serialConfigToCheck)
{
    ...
    for (index = 0; index < 2; index++) {
        ...
        if (bitCount > 1) {
            ...
            if (!(portConfig->functionMask & (FUNCTION_BLACKBOX | (FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_MSP | FUNCTION_TELEMETRY_SMARTPORT)))) {
