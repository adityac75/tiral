...
static const char * const boardIdentifier = "CJM1";
...
# 1123 "./src/main/io/serial_msp.c"
    ...
    case 54:
        ...
        break;
# 1274 "./src/main/io/serial_msp.c"
    case 70:
        serializeDataflashSummaryReply();
        break;
# 1288 "./src/main/io/serial_msp.c"
    case 69:
...
static _Bool processInCommand(void)
{
    ...
    case 214:
        ...
        break;
    case 212:
# 1498 "./src/main/io/serial_msp.c"
        break;

    case 242:
# 1516 "./src/main/io/serial_msp.c"
        break;
...
static mspPort_t *mspTelemetryPort = ((void *)0);

void mspSetTelemetryPort(serialPort_t *serialPort)
{
    uint8_t portIndex;
    mspPort_t *candidatePort = ((void *)0);
    mspPort_t *matchedPort = ((void *)0);
...
void sendMspTelemetry(void)
{
    ...
    sequenceIndex++;
    if (sequenceIndex >= (sizeof(mspTelemetryCommandSequence) / sizeof(mspTelemetryCommandSequence[0]))) {
        sequenceIndex = 0;
    }
}
