...
_Bool sbusInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    ...
    serialPort_t *sBusPort = openSerialPort(portConfig->identifier, FUNCTION_RX_SERIAL, sbusDataReceive, 100000, MODE_RX, (SERIAL_STOPBITS_2 | SERIAL_PARITY_EVEN | SERIAL_INVERTED));
