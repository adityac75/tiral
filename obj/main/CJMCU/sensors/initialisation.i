...
_Bool sensorsAutodetect(sensorAlignmentConfig_t *sensorAlignmentConfig, uint16_t gyroLpf, uint8_t accHardwareToUse, uint8_t magHardwareToUse, uint8_t baroHardwareToUse, int16_t magDeclinationFromConfig);
...
{
# 153 "./src/main/sensors/initialisation.c"
    return ((void *)0);
}
# 199 "./src/main/sensors/initialisation.c"
_Bool detectGyro(void)
{
    ...
    switch(gyroHardware) {
        ...
        case GYRO_MPU6050:
            ...
            ;
        case GYRO_L3G4200D:
# 229 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU3050:
# 241 "./src/main/sensors/initialisation.c"
            ;
...
# 265 "./src/main/sensors/initialisation.c"
        ...
        case GYRO_MPU6500:
# 283 "./src/main/sensors/initialisation.c"
            ;
...
retry:
    ...
    switch (accHardwareToUse) {
        case ACC_DEFAULT:
            ;
        case ACC_ADXL345:
# 337 "./src/main/sensors/initialisation.c"
            ;
        case ACC_LSM303DLHC:
# 348 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6050:
            ...
            ;
        case ACC_MMA8452:
# 375 "./src/main/sensors/initialisation.c"
            ;
        case ACC_BMA280:
# 386 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6000:
# 397 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6500:
# 413 "./src/main/sensors/initialisation.c"
            ;
        case ACC_FAKE:
...
# 476 "./src/main/sensors/initialisation.c"
    switch (baroHardware) {
        case BARO_DEFAULT:
            ;
...
# 569 "./src/main/sensors/initialisation.c"
retry:
    ...
    switch(magHardwareToUse) {
        ...
        case MAG_AK8975:
# 599 "./src/main/sensors/initialisation.c"
            ;
