...
#define MAX_INVALID_PULS_TIME    600 //300 failsafe_drona
...
void updateRx(uint32_t currentTime)
{
    ...
    if (feature(FEATURE_RX_MSP)) {
        ...
        if (rxDataReceived) {
            ...
            needRxSignalBefore = currentTime + DELAY_5_HZ + 300000;//failsafe_drona
        }
    }
            ...
            switch (channel) {
                ...
                case THROTTLE:
                    if (feature(FEATURE_3D))
                        ...
                        return 1200;//rxConfig->rx_min_usec; failsafe_drona
            }
            /* no break */
